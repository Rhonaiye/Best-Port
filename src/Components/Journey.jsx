...
const Journey = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 pt-16">
      <h2 className="text-5xl font-bold text-center bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent pb-1 mb-[10vh]">My Learning Journey</h2>
      <Timeline mode="alternate">
        {journeyData.map((entry, index) => (
          ...
          >
            <h3 className="text-2xl font-extrabold text-blue-600">{entry.year}</h3>
            <h4 className="text-md font-bold text-blue-600 ">{entry.technology}</h4>
            <p className="text-blue-300 text-sm font-extralight mb-[5vh] md:mb-[10vh]">{entry.description}</p>
          </Timeline.Item>
        ))}
      </Timeline>
    </div>
