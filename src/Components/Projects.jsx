  ...
  return(
   <div className="md:px-3">
    ...
    <div className="flex flex-col items-center py-4 md:flex-row md:justify-center md:gap-x-20 font-bold"  >
       ...
       <div className="bg-[#c8c8c8df] px-10 py-5 mb-5 md:h-64 rounded-xl h-1/2 md:w-1/4 " data-aos='zoom-in' data-aos-duration='1000' data-aos-delay='300'>
       <p>RPS-game</p>
       ...
       <div className="bg-[#c8c8c8df] px-10 py-5 mb-5 md:h-64 rounded-xl md:w-1/4" >
         <p>Quote</p>
       ...
       <div className="bg-[#c8c8c8df] px-5 py-5 mb-5 md:h-64 rounded-xl md:w-1/4" data-aos='zoom-in' data-aos-duration='1000' data-aos-delay='300'>
